...
**(注意)** ~~このドキュメントは、まだ、アルゴリズムデザインコンテスト2022年向けの更新漏れがあり、古い情報が書かれている可能性があります。~~


DAシンポジウム2022にて開催されるアルゴリズムデザインコンテスト(ADC)では、クライアント・サーバ方式による、自動運用システムを導入します。
...
1. `git clone -b adc2022-yt https://github.com/dasadc/adc2019.git` を実行します。
